...
export class ProfileView extends React.Component {
    ...
    getUser = (token) => {
        ...
        axios
            .get(`https://calem-test-api.herokuapp.com/users/${Username}`, {
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                `https://calem-test-api.herokuapp.com/users/${Username}`,
                {
    ...
    onDeleteUser() {
        ...
        axios
            .delete(`https://calem-test-api.herokuapp.com/users/${Username}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
